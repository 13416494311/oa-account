...
public class test {
    ...
    public static String vatInvoice() {
        ...
        try {
            // 本地文件路径
            String filePath = "C:\\Users\\Administrator.ZX-201704101859\\Downloads\\测试.jpg";
    ...
    public static String getAuth() {
        ...
        String clientId = "x0Tw65rE41bEK4OkvTCzwbU6";
        // 官网获取的 Secret Key 更新为你注册的Secret Key
        String clientSecret = "xoUGHuF1WsD2wdHsPBWfGtGYcFK6b21m";
    ...
    public static void main(String[] args) {
        //vatInvoice();
        System.out.print(NumberUtils.isNumber("6%"));
        System.out.print(NumberUtils.isNumber("0.01"));

        System.out.print(NumberUtils.isNumber("1"));
    }
}
