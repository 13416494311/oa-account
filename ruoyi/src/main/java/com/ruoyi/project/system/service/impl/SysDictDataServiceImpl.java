...
public class SysDictDataServiceImpl implements ISysDictDataService
{
    ...
    @Override
    public List<SysDictData> selectDictDataByTypeAndExcludeType(String dictType,String excludeDictType)
    {
        return dictDataMapper.selectDictDataByTypeAndExcludeType(dictType,excludeDictType);
    }
